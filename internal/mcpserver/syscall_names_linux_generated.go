...
// Source: golang.org/x/sys/unix zsysnum_linux_*.go files.

package mcpserver

var linuxSyscallNamesByArch = map[string]map[uint64]string{
	"386": {
		0:   "restart_syscall",
		1:   "exit",
		2:   "fork",
	...
	"mips": {
		...
		4449: "futex_waitv",
		4450: "set_mempolicy_home_node",
		4451: "cachestat",
		4452: "fchmodat2",
		4453: "map_shadow_stack",
		4454: "futex_wake",
		4455: "futex_wait",
		4456: "futex_requeue",
		4457: "statmount",
		4458: "listmount",
		4459: "lsm_get_self_attr",
		4460: "lsm_set_self_attr",
		4461: "lsm_list_modules",
		4462: "mseal",
		4463: "setxattrat",
		4464: "getxattrat",
		4465: "listxattrat",
...
func linuxSyscallName(arch string, nr uint64) (string, bool) {
	switch arch {
	case "aarch64":
		arch = "arm64"
	case "x86_64":
