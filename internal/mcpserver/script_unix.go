...
func scriptUnixExtensionNames() []string {
	return []string{
		"constant", "access", "faccessat", "chmod", "fchmod", "fchmodat", "chown", "fchown", "fchownat", "lchown",
		...
		"openat", "fstatat", "statfs", "fstatfs", "statx", "readlinkat", "truncate", "ftruncate", "fsync", "fdatasync", "sync", "syncfs",
		"dup", "dup2", "dup3", "pipe", "pipe2", "closeRange", "setNonblock", "fcntlInt", "getcwd", "chdir", "fchdir",
		"getids", "getgroups", "getresuid", "getresgid", "getrlimit", "setrlimit", "getrusage",
		"eventfd", "memfdCreate", "inotifyInit", "inotifyInit1", "inotifyAddWatch", "inotifyRmWatch", "sendfile", "copyFileRange",
