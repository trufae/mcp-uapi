...
func namedConstants() map[string]uint64 {
	return map[string]uint64{
		...
		"BPF_MAP_TYPE_HASH": uint64(cebpf.Hash), "BPF_MAP_TYPE_ARRAY": uint64(cebpf.Array), "BPF_MAP_TYPE_PROG_ARRAY": uint64(cebpf.ProgramArray), "BPF_MAP_TYPE_PERF_EVENT_ARRAY": uint64(cebpf.PerfEventArray), "BPF_MAP_TYPE_PERCPU_HASH": uint64(cebpf.PerCPUHash), "BPF_MAP_TYPE_PERCPU_ARRAY": uint64(cebpf.PerCPUArray), "BPF_MAP_TYPE_STACK_TRACE": uint64(cebpf.StackTrace), "BPF_MAP_TYPE_CGROUP_ARRAY": uint64(cebpf.CGroupArray), "BPF_MAP_TYPE_LRU_HASH": uint64(cebpf.LRUHash), "BPF_MAP_TYPE_LRU_PERCPU_HASH": uint64(cebpf.LRUCPUHash), "BPF_MAP_TYPE_LPM_TRIE": uint64(cebpf.LPMTrie), "BPF_MAP_TYPE_ARRAY_OF_MAPS": uint64(cebpf.ArrayOfMaps), "BPF_MAP_TYPE_HASH_OF_MAPS": uint64(cebpf.HashOfMaps), "BPF_MAP_TYPE_DEVMAP": uint64(cebpf.DevMap), "BPF_MAP_TYPE_SOCKMAP": uint64(cebpf.SockMap), "BPF_MAP_TYPE_CPUMAP": uint64(cebpf.CPUMap), "BPF_MAP_TYPE_XSKMAP": uint64(cebpf.XSKMap), "BPF_MAP_TYPE_SOCKHASH": uint64(cebpf.SockHash), "BPF_MAP_TYPE_QUEUE": uint64(cebpf.Queue), "BPF_MAP_TYPE_STACK": uint64(cebpf.Stack), "BPF_MAP_TYPE_RINGBUF": uint64(cebpf.RingBuf), "BPF_MAP_TYPE_BLOOM_FILTER": uint64(cebpf.BloomFilter), "BPF_MAP_TYPE_USER_RINGBUF": uint64(cebpf.UserRingbuf), "BPF_MAP_TYPE_ARENA": uint64(cebpf.Arena),
		"BPF_PROG_TYPE_SOCKET_FILTER": uint64(cebpf.SocketFilter), "BPF_PROG_TYPE_KPROBE": uint64(cebpf.Kprobe), "BPF_PROG_TYPE_SCHED_CLS": uint64(cebpf.SchedCLS), "BPF_PROG_TYPE_SCHED_ACT": uint64(cebpf.SchedACT), "BPF_PROG_TYPE_TRACEPOINT": uint64(cebpf.TracePoint), "BPF_PROG_TYPE_XDP": uint64(cebpf.XDP), "BPF_PROG_TYPE_PERF_EVENT": uint64(cebpf.PerfEvent), "BPF_PROG_TYPE_CGROUP_SKB": uint64(cebpf.CGroupSKB), "BPF_PROG_TYPE_CGROUP_SOCK": uint64(cebpf.CGroupSock), "BPF_PROG_TYPE_SOCK_OPS": uint64(cebpf.SockOps), "BPF_PROG_TYPE_SK_SKB": uint64(cebpf.SkSKB), "BPF_PROG_TYPE_SK_MSG": uint64(cebpf.SkMsg), "BPF_PROG_TYPE_RAW_TRACEPOINT": uint64(cebpf.RawTracepoint), "BPF_PROG_TYPE_CGROUP_SOCK_ADDR": uint64(cebpf.CGroupSockAddr), "BPF_PROG_TYPE_SK_REUSEPORT": uint64(cebpf.SkReuseport), "BPF_PROG_TYPE_FLOW_DISSECTOR": uint64(cebpf.FlowDissector), "BPF_PROG_TYPE_CGROUP_SYSCTL": uint64(cebpf.CGroupSysctl), "BPF_PROG_TYPE_TRACING": uint64(cebpf.Tracing), "BPF_PROG_TYPE_STRUCT_OPS": uint64(cebpf.StructOps), "BPF_PROG_TYPE_EXT": uint64(cebpf.Extension), "BPF_PROG_TYPE_LSM": uint64(cebpf.LSM), "BPF_PROG_TYPE_SK_LOOKUP": uint64(cebpf.SkLookup), "BPF_PROG_TYPE_SYSCALL": uint64(cebpf.Syscall), "BPF_PROG_TYPE_NETFILTER": uint64(cebpf.Netfilter),
		"BPF_ATTACH_TYPE_CGROUP_INET_INGRESS": uint64(cebpf.AttachCGroupInetIngress), "BPF_ATTACH_TYPE_CGROUP_INET_EGRESS": uint64(cebpf.AttachCGroupInetEgress), "BPF_ATTACH_TYPE_TRACE_FENTRY": uint64(cebpf.AttachTraceFEntry), "BPF_ATTACH_TYPE_TRACE_FEXIT": uint64(cebpf.AttachTraceFExit), "BPF_ATTACH_TYPE_TRACE_RAW_TP": uint64(cebpf.AttachTraceRawTp), "BPF_ATTACH_TYPE_XDP": uint64(cebpf.AttachXDP),
		"BPF_ANY": unix.BPF_ANY, "BPF_NOEXIST": unix.BPF_NOEXIST, "BPF_EXIST": unix.BPF_EXIST, "BPF_F_LOCK": unix.BPF_F_LOCK, "BPF_F_NO_PREALLOC": unix.BPF_F_NO_PREALLOC, "BPF_F_RDONLY": unix.BPF_F_RDONLY, "BPF_F_WRONLY": unix.BPF_F_WRONLY, "BPF_F_RDONLY_PROG": unix.BPF_F_RDONLY_PROG, "BPF_F_WRONLY_PROG": unix.BPF_F_WRONLY_PROG, "BPF_F_NUMA_NODE": unix.BPF_F_NUMA_NODE, "BPF_F_MMAPABLE": unix.BPF_F_MMAPABLE, "BPF_F_PRESERVE_ELEMS": unix.BPF_F_PRESERVE_ELEMS, "BPF_F_CURRENT_CPU": unix.BPF_F_CURRENT_CPU,
		"XDP_ABORTED": 0, "XDP_DROP": 1, "XDP_PASS": 2, "XDP_TX": 3, "XDP_REDIRECT": 4, "XDP_GENERIC_MODE": uint64(link.XDPGenericMode), "XDP_DRIVER_MODE": uint64(link.XDPDriverMode), "XDP_OFFLOAD_MODE": uint64(link.XDPOffloadMode),
		"BPF_LOG_LEVEL1": uint64(cebpf.LogLevelBranch), "BPF_LOG_LEVEL2": uint64(cebpf.LogLevelInstruction), "BPF_LOG_STATS": uint64(cebpf.LogLevelStats),
	}
}
